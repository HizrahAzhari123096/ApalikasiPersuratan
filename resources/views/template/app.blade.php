      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item{{ request()->is('pengguna') ? ' active' : '' }}"><a href="{{ url('/users') }}"><i class="fas fa-user-friends"></i><span> Users</span></a></li>
            ...
            <li class="nav-item{{ request()->is('namatandatangan') ? ' active' : '' }}"><a href="{{ url('/namatandatangan') }}"><i class="far fa-bell"></i><span>Nama Tanda Tangan</span></a></li>
