                    ...
                    <div class="card-body">
                          ...
                          @csrf
                            <div class="form-group">
                                ...
                                <input type="text" name="id" class="form-control" placeholder="Enter ID nama tanda tangan">
                                @error('id')
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="nama_tandatangan" class="form-control" placeholder="Enter nama tanda tangan">
